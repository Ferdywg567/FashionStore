        ...
        <div class="container">
            <div
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-87f0d9d3ac29375f" aria-live="off"
                    ...
                    <div
                        class="ec-slide-item swiper-slide d-flex slide-3 swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
                ...
                <div
                    ...
                    <span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button"
                        ...
                        class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <!-- ec Top Rated -->
                        <div
                            class="col-lg-4 col-md-6 col-sm-12 col-xs-6 ec-all-product-content ec-new-product-content m-auto"
                            data-animation="fadeIn">
                            <div class="col-md-12">
                                <div class="section-title">
